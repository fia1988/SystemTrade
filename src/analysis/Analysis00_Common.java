...
//				nowDTO.setNowCREDIT_RATIO_CHANGERATE_01(RS.getDouble(	 ReCord.STOCK_TBK_DD_A + "." + COLUMN.CREDIT_RATIO_CHANGERATE		));
				...
				nowDTO.setMARKET_RISK_FOR_BETA_AVE(RS.getDouble(	 ReCord.MARKET_LETTER + "." + COLUMN.MARKET_RISK_FOR_BETA_AVE ));//標準偏差平均
				nowDTO.setCAPM(RS.getDouble(	 ReCord.STOCK_TBK_DD_A + "." + COLUMN.CAPM	 ));//CAPM				//CAPM株主資本コスト（リスクフリーレート+ベータ*マーケットリスクプレミアム）
