...
//		//仮ファイルを削除
	...
	private void updateZenzituhi(String TBL,String cate,String TODAY,String lastUpdateDay,S s){
		...
		switch (cate){
			...
			case ReCord.CODE_HESO_02_INVEST:
				updateColumn = " "
					+ "b." + COLUMN_TBL.MARKET_CAP_PPT_PRE				 + " = "+ "a." + COLUMN_TBL.MARKET_CAP_PPT			 + " , "
					+ "b." + COLUMN_TBL.STOCK_NUM_PRE					 + " = "+ "a." + COLUMN_TBL.STOCK_NUM				 + " , "
					+ "b." + COLUMN_TBL.DIVIDEND_PER_PRE 				 + " = "+ "a." + COLUMN_TBL.DIVIDEND_PER 			 + " , "
					+ "b." + COLUMN_TBL.DIVIDEND_PRE  					 + " = "+ "a." + COLUMN_TBL.DIVIDEND  				 + " , "
					+ "b." + COLUMN_TBL.PER_YOSO_PRE  					 + " = "+ "a." + COLUMN_TBL.PER_YOSO  				 + " , "
					+ "b." + COLUMN_TBL.PBR_REAL_PRE  					 + " = "+ "a." + COLUMN_TBL.PBR_REAL  				 + " , "
					+ "b." + COLUMN_TBL.EPS_YOSO_PRE 					 + " = "+ "a." + COLUMN_TBL.EPS_YOSO 				 + " , "
					+ "b." + COLUMN_TBL.BPS_REAL_PRE 					 + " = "+ "a." + COLUMN_TBL.BPS_REAL 				 + " , "
					+ "b." + COLUMN_TBL.YEAR_MAX_DAY_YYYYMMDD_PRE 		 + " = "+ "a." + COLUMN_TBL.YEAR_MAX_DAY_YYYYMMDD 	 + " , "
					+ "b." + COLUMN_TBL.YEAR_MAX_PRE 					 + " = "+ "a." + COLUMN_TBL.YEAR_MAX 				 + " , "
					+ "b." + COLUMN_TBL.YEAR_MIN_DAY_YYYYMMDD_PRE 		 + " = "+ "a." + COLUMN_TBL.YEAR_MIN_DAY_YYYYMMDD 	 + " , "
					+ "b." + COLUMN_TBL.YEAR_MIN_PRE 					 + " = "+ "a." + COLUMN_TBL.YEAR_MIN 				 + "   ";
				break;
			case  ReCord.CODE_HESO_03_FINANCE:
				//これはやらん
				return;
			case  ReCord.CODE_HESO_04_RATIO:
				updateColumn = " "
					+ "b." + COLUMN_TBL.ANOTHER_STOCK_HOLDER_RATIO_PRE		 + " = "+ "a." + COLUMN_TBL.ANOTHER_STOCK_HOLDER_RATIO		 + " , "
					+ "b." + COLUMN_TBL.MAJOR_STOCK_HOLDER_RATIO_PRE		 + " = "+ "a." + COLUMN_TBL.MAJOR_STOCK_HOLDER_RATIO		 + " , "
					+ "b." + COLUMN_TBL.ETF_STOCK_HOLDER_RATIO_PRE			 + " = "+ "a." + COLUMN_TBL.ETF_STOCK_HOLDER_RATIO			 + " , "
					+ "b." + COLUMN_TBL.FOREIGNER_STOCK_HOLDER_RATIO_PRE	 + " = "+ "a." + COLUMN_TBL.FOREIGNER_STOCK_HOLDER_RATIO	 + "   " ;
				break;
			case  ReCord.CODE_HESO_05_CREDIT:
				updateColumn = " "
					+ "b." + COLUMN_TBL.CREDIT_LONG_PRE					 + " = " + "a." + COLUMN_TBL.CREDIT_LONG				 + " , "
					+ "b." + COLUMN_TBL.CREDIT_LONG_CHANGERATE_W_PRE	 + " = " + "a." + COLUMN_TBL.CREDIT_LONG_CHANGERATE_W	 + " , "
					+ "b." + COLUMN_TBL.CREDIT_SHORT_PRE				 + " = " + "a." + COLUMN_TBL.CREDIT_SHORT				 + " , "
					+ "b." + COLUMN_TBL.CREDIT_SHORT_CHANGERATE_W_PRE	 + " = " + "a." + COLUMN_TBL.CREDIT_SHORT_CHANGERATE_W	 + " , "
					+ "b." + COLUMN_TBL.CREDIT_RATIO_PRE				 + " = " + "a." + COLUMN_TBL.CREDIT_RATIO				 + "  " ;
...
//		a.daytime = '2017-01-01' ;
		...
		String SQL = " update " + TBL + " b "
					...
					+ " and "
					+ "a." + COLUMN_TBL.DAYTIME + " = '" + lastUpdateDay + "' ";
